...
import { FaDownload, FaExternalLinkAlt, FaQrcode, FaSpinner, FaExclamationTriangle, FaRedo } from 'react-icons/fa';
    ...
    <div className="max-w-4xl mx-auto pb-8">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center gap-4">
          ...
          <h2 className="text-lg font-bold text-white">Failed to load QR Code</h2>
          <p className="text-gray-400 text-sm max-w-xs">
            Could not fetch your restaurant details. Please check your connection and try again.
          </p>
          <button
            onClick={fetchSlug}
        ...
        <FadeIn delay={0.2} direction="up" className="bg-brand-surface border border-brand-border rounded-xl p-8 lg:p-12 shadow-sm flex flex-col md:flex-row items-center md:items-start gap-8 lg:gap-12">
          ...
          <div className="flex-1 w-full text-center md:text-left">
            ...
            <p className="text-gray-400 leading-relaxed mb-6">
              Your QR code securely links directly to your live digital menu. Whenever you add a new item or change a discount, customers scanning this code instantly see the latest updates. There are absolutely <strong>no re-prints required!</strong>
            </p>
            ...
            <div className="mt-8 pt-6 border-t border-brand-border flex items-center justify-center md:justify-start gap-3 text-sm text-gray-500">
              <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse mt-[2px]" />
              Live tracking via <span className="text-gray-300 font-mono select-all">/menu/{slug}</span>
            </div>
          </div>
        </FadeIn>
      )}
